    ...
    internal partial class Program
    {
        ...
        private static List<Action> ActionDemos()
        {
            return new List<Action>(){
                ...
                new Action(PartialClassesDemo.Show),             //部分类
                new Action(MyDerived.OverideDemo),              //类的重写 overide
                new Action(NamedAndOptional.Show),               //可选的命名参数
                new Action(Generics.SortList),                  //泛型                                    
                new Action(CovariantDemo.Show),                  //继承与协变逆变

                //Struct与Class的区别
                new Action(ClassAndStructDemo.Show),
                ...
                //属性
                new Action(PropertiesDemo.PropertiesAssign),
                new Action(PropertiesDemo.PropertiesOveride),

                //特性 Custom Attribute
                new Action(AttributeDemo.Customerize),                //Custom Attribute
                ...
                //Event
                new Action(EventListenDemo.Show),
                ...
                ////类库引用
                new Action(LibraryRefDemo.Show),
